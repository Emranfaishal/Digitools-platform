            ...
            <div className='container mx-auto '>
                <div className='mt-10'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10'>
                        ...
                        <div className="card w-full bg-base-200 shadow-sm hover:-translate-y-3 duration-300 hover:shadow-xl">
                        ...
                        <div className="card w-full bg-linear-to-t from-indigo-500 to-indigo-500 shadow-sm hover:-translate-y-3 duration-300 hover:shadow-xl">
                            <div>
